...
<section class="slider">
    ...
    <ul>  <!-- SLIDE  -->
        ...
        <div class="tp-caption   tp-resizeme"
          ...
          style="z-index: 8;"><img src="{{asset('images/main_slider/1.jpg')}}" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
      ...
      <!-- SLIDE  -->
        ...
        <div class="tp-caption   tp-resizeme"
          ...
          style="z-index: 12;"><img src="{{asset('images/main_slider/2.jpg')}}" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
      </li>
    </ul>
    <div class="tp-bannertimer tp-bottom" style="visibility: hidden !important;"></div> </div>
    </div>
